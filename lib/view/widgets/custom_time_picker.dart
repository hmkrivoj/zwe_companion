...
const Duration _kDialAnimateDuration = Duration(milliseconds: 1000);
...
Future<ZweInstant> showCustomTimePicker(
    {@required BuildContext context, ZweInstant initial}) {
  assert(context != null);
  final instant = initial ?? ZweInstant.now();
  final timeOfDay = TimeOfDay(hour: instant.hour, minute: instant.minute);
